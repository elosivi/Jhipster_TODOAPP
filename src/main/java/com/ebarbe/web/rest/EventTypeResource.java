...
import com.ebarbe.service.EventTypeQueryService;
import com.ebarbe.service.EventTypeService;
...
public class EventTypeResource {
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<EventTypeDTO> getEventType(@PathVariable("id") Long id) {
