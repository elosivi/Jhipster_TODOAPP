 ...
 * <p>
 * This class accesses the {@link com.ebarbe.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
...
public class UserExtendedResource extends UserResource {
    ...
    public UserExtendedResource(
        ...
        super(userService, userRepository, mailService, personService);
        this.userService = userService;
    }

    @GetMapping("/userByLogin/{login}")
    public ResponseEntity<AdminUserDTO> getUserByLogin(@PathVariable("login") @Pattern(regexp = Constants.LOGIN_REGEX) String login) {
