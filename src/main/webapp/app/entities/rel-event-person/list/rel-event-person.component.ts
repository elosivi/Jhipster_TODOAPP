...
@Component({
  standalone: true,
  selector: 'jhi-rel-event-person',
  templateUrl: './rel-event-person.component.html',
  imports: [
    RouterModule,
    FormsModule,
    SharedModule,
...
export class RelEventPersonComponent implements OnInit {
  ...
  protected queryBackend(
    ...
    if (this.currentSearch && this.currentSearch !== '') {
      ...
      return this.relEventPersonService.findAllWithRelationData(queryObject).pipe(tap(() => (this.isLoading = false)));
    }
  }
