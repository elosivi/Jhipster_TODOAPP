...
const requireRestSample: RestEvent = {
  ...
  dateStart: sampleWithRequiredData.dateStart?.format(DATE_FORMAT),
  dateEnd: sampleWithRequiredData.dateEnd?.format(DATE_FORMAT),
};
...
describe('Event Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should handle exceptions for searching a Event', () => {
