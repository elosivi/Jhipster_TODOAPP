...
describe('EventType Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'event-type', component: EventTypeComponent }]),
  ...
  describe('trackId', () => {
    it('Should forward to eventTypeService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getEventTypeIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getEventTypeIdentifier).toHaveBeenCalledWith(entity);
