...
class CategoryResourceIT {
    ...
    @Test
    @Transactional
    void getAllCategoriesByLabelIsEqualToSomething() throws Exception {
        // Initialize the database
        categoryRepository.saveAndFlush(category);
    ...
    @Test
    @Transactional
    void getAllCategoriesByLabelIsInShouldWork() throws Exception {
        // Initialize the database
        categoryRepository.saveAndFlush(category);
    ...
    @Test
    @Transactional
    void getAllCategoriesByLabelIsNullOrNotNull() throws Exception {
        // Initialize the database
        categoryRepository.saveAndFlush(category);
    ...
    @Test
    @Transactional
    void getAllCategoriesByLabelContainsSomething() throws Exception {
        // Initialize the database
        categoryRepository.saveAndFlush(category);
    ...
    @Test
    @Transactional
    void getAllCategoriesByLabelNotContainsSomething() throws Exception {
        // Initialize the database
        categoryRepository.saveAndFlush(category);
    ...
    @Test
    @Transactional
    void getAllCategoriesByMainTaskIsEqualToSomething() throws Exception {
        MainTask mainTask;
        ...
        em.persist(mainTask);
        em.flush();
        category.addMainTask(mainTask);
        categoryRepository.saveAndFlush(category);
        Long mainTaskId = mainTask.getId();
        // Get all the categoryList where mainTask equals to mainTaskId
        defaultCategoryShouldBeFound("mainTaskId.equals=" + mainTaskId);

        // Get all the categoryList where mainTask equals to (mainTaskId + 1)
        defaultCategoryShouldNotBeFound("mainTaskId.equals=" + (mainTaskId + 1));
    }
